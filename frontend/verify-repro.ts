import { LayoutEngine } from './src/components/canvas/layout/LayoutEngine.js';
import { annotateStepsWithPlacementKeys, buildConditionTree } from './src/ExecutionStructureBuilder.js';

// Stub out canvas things if LayoutEngine imports them
const emptyState = { globals: {}, stack: [], heap: {}, callStack: [] };
const makeTrace = (steps: any[]) => ({
...
try {
  const layout = LayoutEngine.calculateLayout(trace as any, null as any, trace.steps.length - 1, 1200);
